...
|
*/
$config['base_url'] = getenv('APP_BASE_URL') ? rtrim(getenv('APP_BASE_URL'), '/').'/' : 'http://localhost/alumni-influencers/';
...
|
*/
$config['encryption_key'] = getenv('APP_ENCRYPTION_KEY') ? getenv('APP_ENCRYPTION_KEY') : '';
...
$config['cookie_secure']	= getenv('APP_COOKIE_SECURE') !== FALSE
	? filter_var(getenv('APP_COOKIE_SECURE'), FILTER_VALIDATE_BOOLEAN)
